...
if(laser_fusion_CONFIG_INCLUDED)
  return()
endif()
set(laser_fusion_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(laser_fusion_SOURCE_PREFIX /home/sishubin/SLAMcodes/My_Local_Repo/Laser_fusion/src/laser_fusion)
  set(laser_fusion_DEVEL_PREFIX /home/sishubin/SLAMcodes/My_Local_Repo/Laser_fusion/devel)
  set(laser_fusion_INSTALL_PREFIX "")
  set(laser_fusion_PREFIX ${laser_fusion_DEVEL_PREFIX})
else()
  set(laser_fusion_SOURCE_PREFIX "")
  set(laser_fusion_DEVEL_PREFIX "")
  set(laser_fusion_INSTALL_PREFIX /home/sishubin/SLAMcodes/My_Local_Repo/Laser_fusion/install)
  set(laser_fusion_PREFIX ${laser_fusion_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'laser_fusion' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND laser_fusion_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sishubin/SLAMcodes/My_Local_Repo/Laser_fusion/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(laser_fusion_LIBRARY_DIRS ${lib_path})
      list(APPEND laser_fusion_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'laser_fusion'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND laser_fusion_LIBRARIES ${lib})
    endif()
  endif()
...
set(laser_fusion_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${laser_fusion_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;rospy;std_msgs;geometry_msgs;nav_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 laser_fusion_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${laser_fusion_dep}_FOUND)
      find_package(${laser_fusion_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${laser_fusion_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(laser_fusion_INCLUDE_DIRS ${${laser_fusion_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(laser_fusion_LIBRARIES ${laser_fusion_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${laser_fusion_dep}_LIBRARIES})
  _list_append_deduplicate(laser_fusion_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(laser_fusion_LIBRARIES ${laser_fusion_LIBRARIES})

  _list_append_unique(laser_fusion_LIBRARY_DIRS ${${laser_fusion_dep}_LIBRARY_DIRS})
  list(APPEND laser_fusion_EXPORTED_TARGETS ${${laser_fusion_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${laser_fusion_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
